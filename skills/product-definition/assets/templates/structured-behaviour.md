...
An externally visible API operation, event or document may be named when it is part of the
product contract.
...
<!-- What this example does not assert where a reader could otherwise mistake it for
broader behaviour. "None." is valid when no material boundary is known. -->
